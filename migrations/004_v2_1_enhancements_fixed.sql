...
-- 2. Template Versions Table (для истории версий)
...
-- 3. User Settings Table (сохранение пользовательских настроек)
...
-- 4. Template Sync State Table (для синхронизации между устройствами)
...
-- 5. Change Log Table (для отслеживания всех изменений)
